    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="photo" label="图片地址">
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="ModVisible" width="30%">
            <el-form ref="ModForm" :model="ModForm" label-width="85px" :rules="rulesm">
                ...
                <el-form-item label="图片" prop="url">
                    <input class="uploadimgm" type="file" @change="uploadImage" ref="file">
                </el-form-item>
                ...
                <el-form-item label="项目id" prop="project_id">
                    <el-input v-model="ModForm.project_id"></el-input>
                </el-form-item>
                <el-form-item label="状态">
                ...
                jsonString: JSON.stringify([
                    {
                        ...
                        tilte: this.ModForm.title,
                        url: this.ModForm.url,
                        parent_id: this.ModForm.parent_id,
                        description: this.ModForm.description,
                        project_id: this.ModForm.project_id,
                        state:
                            this.ModForm.state == "" ? "0" : this.ModForm.state,
                        photo: this.ModForm.photo,
                        sequence:
                            this.ModForm.sequence == ""
                                ? "0"
                                : this.ModForm.sequence,
